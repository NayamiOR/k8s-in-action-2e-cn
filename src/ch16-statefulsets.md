...
> **清单 16.1 quiz StatefulSet 的无头 Service**
>
> ```yaml
> apiVersion: v1
> kind: Service
...
> **清单 16.3 quiz-data-importer Pod 的清单**
>
> ```yaml
> apiVersion: v1
> kind: Pod
...
> **清单 16.4 在 StatefulSet 中配置 PersistentVolumeClaim 保留策略**
>
> ```yaml
> apiVersion: apps/v1
> kind: StatefulSet
...
> **清单 16.5 在 StatefulSet 中指定 **podManagementPolicy****
>
> ```yaml
> apiVersion: apps/v1
> kind: StatefulSet
...
> **清单 16.7 使用 partition 字段暂存 StatefulSet 更新**
>
> ```yaml
> apiVersion: apps/v1
> kind: StatefulSet
...
> **清单 16.9 MongoDBCommunity 自定义对象清单**
>
> ```yaml
