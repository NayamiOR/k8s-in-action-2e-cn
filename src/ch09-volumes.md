...
> **清单 9.2 带有 emptyDir 卷的 **quiz** Pod，供 **mongo** 容器使用**
>
> ```yaml
> apiVersion: v1
> kind: Pod
...
> **清单 9.3 **insert-questions.js** 文件的内容**
>
> ```text
...
> **清单 9.4 **quiz-initdb-script-installer:0.1** 容器镜像的 Dockerfile**
>
> ```dockerfile
> FROM busybox
...
> **清单 9.9 使用 **hostPath** 卷获取对宿主节点文件系统的访问**
>
> ```yaml
> apiVersion: v1
> kind: Pod
...
> **清单 9.11 指定要在 **configMap** 卷中包含哪些 ConfigMap 条目**
>
> ```yaml
>   volumes:
>   - name: envoy-config
...
> **清单 9.15 使用 **projected** 卷代替 **configMap** 和 **secret** 卷**
>
> ```yaml
> apiVersion: v1
> kind: Pod
...
> **清单 9.16 几乎每个 Pod 中内置的 **kube-api-access** 卷**
>
> ```yaml
> volumes:
